...
public class CustomHelper {
    ...
    public void onClick(View view, XTakePhoto takePhoto) {
    ...
    private void configTakePhotoOption(XTakePhoto takePhoto) {
    ...
    private void configCompress(XTakePhoto takePhoto) {
